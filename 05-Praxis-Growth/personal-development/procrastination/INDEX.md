...
- [01 拖延症概述 | Procrastination Overview](01_拖延症概述.md) — 定义、类型、流行病学数据、神经生物学基础、时间动机理论
- [02 拖延症成因与机制 | Causes and Mechanisms](02_拖延症成因与机制.md) — 时间折扣、恐惧失败、完美主义、执行功能障碍、情绪调节理论
- [03 拖延症应对策略 | Practical Strategies](03_拖延症应对策略.md) — 番茄工作法、执行意图、诱惑捆绑、认知重构、环境设计、两分钟法则、自我慈悲
- [04 拖延与心理健康 | Procrastination and Mental Health](04_拖延与心理健康.md) — 焦虑、抑郁、ADHD、自我慈悲理论、专业转介指南
- [拖延症心理调节专业内容体系（原始文件）](Procrastination_Psychological_Regulation.md)

## 阅读顺序建议

1. **入门**：从「拖延症概述」了解基本概念和理论框架
2. **深入**：阅读「成因与机制」理解拖延的多层次驱动因素
3. **行动**：参考「应对策略」选择适合个人的干预方法
4. **整合**：结合「心理健康」章节处理拖延背后的情绪和心理议题
