...
- [结构化分类与交叉引用数据](Workplace_Verbal_Bullying_PUA_Taxonomy.json)
...
- [干预与康复：组织干预与心理恢复指南](Workplace_Verbal_Bullying_PUA_Intervention_and_Recovery.md)
...
### 4.2 推荐阅读路径
1. 先读 [应对PUA/羞辱型领导](Workplace_Anti_PUA_Leadership.md)，快速识别高风险行为
2. 再读 [心理学机制文档](Workplace_Verbal_Bullying_PUA_Psychology.md)，理解精神控制如何生效
3. 接着读 [社会学机制文档](Workplace_Verbal_Bullying_PUA_Sociology.md)，理解为什么组织会纵容
4. 然后读 [工作方法论文档](Workplace_Verbal_Bullying_PUA_Response_Methodology.md)，将识别转化为行动
5. 遇到实际纠纷时，联动 [案例库](Workplace_Verbal_Bullying_PUA_Case_Library.md) 与 [法律法规汇编](Workplace_Verbal_Bullying_PUA_Legal_References.md)
6. 在高压事件后，继续使用 [干预与康复指南](Workplace_Verbal_Bullying_PUA_Intervention_and_Recovery.md)
