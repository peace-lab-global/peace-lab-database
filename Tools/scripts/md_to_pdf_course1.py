#!/usr/bin/env python3
"""Convert MOCICI Course 1 textbook from Markdown to high-quality PDF.
...
SRC = (Path(__file__).resolve().parent.parent.parent
       ...
       / "mocici-course-1-meditator" / "MOCICI_Course1_Textbook.md")
OUT = SRC.with_suffix(".pdf")
WORK = Path(tempfile.mkdtemp(prefix="mocici_c1_pdf_"))
