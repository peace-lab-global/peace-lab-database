...
#### 2.3 新建 `规范/MIRROR_POLICY.md` (5.8 KB)
...
#### 3.3 新建 `规范/STUB_POLICY.md` (4.8 KB)
...
#### 4.1 新建 `规范/TAGS_CONVENTIONS.md` (6 KB)
...
```
规范/MIRROR_POLICY.md                                  # 镜像治理规范
规范/STUB_POLICY.md                                    # 骨架治理规范
规范/TAGS_CONVENTIONS.md                               # tags 规范
