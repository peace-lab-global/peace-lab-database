...
`docs/` 目录已迁移至 `规范/`，但 symlink 未更新。MkDocs 构建时这三个文件将缺失。
...
| TAXONOMY.md | 8/10 | 根目录布局图已过时（docs/ → 规范/） |
...
| # | 问题 | 影响 | 修复方案 |
|:--|:-----|:-----|:---------|
| 1 | MkDocs symlink 3 处断裂 | TAXONOMY/GLOSSARY/CONTRIBUTING 在站点不可见 | 更新 symlink 指向 `规范/` |
