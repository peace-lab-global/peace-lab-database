...
│   └── 证据基于方案.md                 ← 循证治疗协议（depression标准化方案）
│
├── meditation/                                        ← 冥想课程体系
...
│
├── depression/                                        ← 抑郁症实操工具包
│   ├── 正念认知复发预防.md                  ← MBCT复发预防临床方案
│   └── 实用工具箱.md                        ← 实操工具包（STOP、接地5-4-3-2-1、身体扫描、四级应对）
│
├── pharmacology/                                      ← 药物整合
...
| 实操技术 | `depression/实用工具箱.md` | STOP、接地、身体扫描 |
...
| 危机计划制定 | `safety/危机安全性.md` | SPI六步安全计划 + 危机卡片 |
