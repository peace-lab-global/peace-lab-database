---
title: "惊恐障碍 (Panic Disorder) | Index"
description: "惊恐障碍 (Panic Disorder) | Index —— 焦虑症 · Panic Disorder 专题"
category: "心智与心理学 > 心理学 > 临床心理 > 焦虑症 > Panic Disorder"
tags: ["treatment", "临床心理", "心理学", "焦虑症", "anxiety"]
...
intent_queries:
  ...
  - "惊恐障碍  | Index的核心概念"
  - "惊恐障碍  | Index的方法与实践"
trigger_keywords: ["惊恐障碍", "treatment", "临床心理"]
cross_refs:
  - path: "03-Bio-Science/death/Death_Anxiety_Sudden_Death_Fear.md"
    relation: "panic/disorder/anxiety"
---
# 惊恐障碍 (Panic Disorder) | Index

> 惊恐障碍的诊断标准、临床表现、评估工具与循证治疗方法。

## 内容索引 | Contents

- [惊恐障碍概览 (Overview)](Panic_Disorder_Overview.md)
- [惊恐障碍临床表现 (Clinical Features)](Panic_Disorder_Clinical_Features.md)
- [惊恐障碍评估 (Assessment)](Panic_Disorder_Assessment.md)
