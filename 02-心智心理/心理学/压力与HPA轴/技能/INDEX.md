...
cross_refs:
  - path: "03-生命科学/生物学/hpaaxis/INDEX.md"
    relation: "axis/hpa/stress"
  - path: "03-生命科学/生物学/hpaaxis/HPA_Axis_Regulation_Interventions.md"
    relation: "hpa/axis/protocol"
---
# Stress & HPA Axis Agent Skills | 技能索引

> 面向智能体的压力与HPA轴调节技能模块。智能体通过遵循[`_方案.md`](方案.md)协议和[`_显化.md`](显化.md)注册清单，可对用户的压力相关问题进行评估、决策辅助和干预指导。
...
├─────────────────────────────────────────────────────────┤
│                                                         │
│  _方案.md ─── 全局协议（角色定义、准入流程、        │
│       │              会话状态、编排规则）              │
│       │                                             │
│  _显化.md ── 技能注册表（元数据、入口触发、         │
│       │              前置要求、输出Schema、            │
│       │              技能链）                         │
│       │                                             │
│  ┌─────┴─────────────────────────────────────────┐    │
...
| ID | 技能 | 文件 | 角色 | 入口触发词 |
|:--:|:-----|:-----|:----:|:-----------|
| S_001 | 压力状态综合评估 | [`Stress_Assessment_Skill.md`](压力评估Skill.md) | entry | 压力/焦虑/紧张/很累 |
| S_003 | 皮质醇节律评估 | [`Cortisol_Rhythm_Assessment_Skill.md`](皮质醇Rhythm评估Skill.md) | depth | 皮质醇/肾上腺/激素 |

### 干预技能 (Intervention)

| ID | 技能 | 文件 | 证据等级 |
|:--:|:-----|:-----|:--------:|
| S_002 | 慢性压力干预决策 | [`Chronic_Stress_Intervention_Skill.md`](慢性压力干预Skill.md) | ★★★ A |
| S_004 | 皮质醇调节方案 | [`Cortisol_Management_Skill.md`](皮质醇管理Skill.md) | ★★★ A |
| S_005 | HPA轴功能调节 | [`HPA_Axis_Regulation_Skill.md`](HPA轴AxisRegulationSkill.md) | ★★☆ B |

### 识别/兜底技能 (Recognition & Escalation)

| ID | 技能 | 文件 | 作用 |
|:--:|:-----|:-----|:-----|
| S_006 | 慢性疲劳综合征识别 | [`CFS_Recognition_Skill.md`](慢性疲劳RecognitionSkill.md) | CFS疑似识别+转介 |
| S_007 | 压力相关健康风险评估 | [`Stress_Health_Risk_Assessment_Skill.md`](压力健康Risk评估Skill.md) | 多系统风险+转介 |

### 工具技能 (Tool)

| ID | 技能 | 文件 | 作用 |
|:--:|:-----|:-----|:-----|
| S_008 | 压力日记分析 | [`Stress_Diary_Analysis_Skill.md`](压力日记分析Skill.md) | 模式识别+建议 |
| S_009 | 放松技术指导 | [`Relaxation_Techniques_Guide_Skill.md`](放松技术指南Skill.md) | 技术推荐+方案 |
...
| 文件 | 用途 |
|:-----|:-----|
| [`_方案.md`](方案.md) | 全局协议：角色定义、准入流程、会话状态、编排规则 |
| [`_显化.md`](显化.md) | 技能注册表：元数据Schema、入口触发、前置要求、输出格式 |
| 本文件 | 技能导航入口 |
| 其他 .md 文件 | 各技能具体内容 |
