...
```mermaid
graph LR
    subgraph 本笃会灵修结构 Benedictine Spirituality
        B1[祈祷 Orare] --> B2[工作 Laborare]
        B2 --> B3[阅读 Lectio]
        B3 --> B1
    end

    subgraph 日课结构 Divine Office
        D1[晨祷 Lauds<br/>↳ 黎明] --> D2[日课 Prime/Terce/Sext/None]
        D2 --> D3[晚祷 Vespers]
        D3 --> D4[夜课 Compline]
    end

    B1 -.->|每日七次祈祷| D1
    B3 -.->|神圣阅读| L1[Lectio Divina<br/>读·默·祈·观]
...
```mermaid
graph TD
    subgraph 爱的神学发展 Theology of Love
        L1[圣伯尔纳铎<br/>《雅歌讲道集》] --> L2[灵魂与基督的<br/>神秘婚姻]
        L2 --> L3[四种爱<br/>Carnalis → Rationalis →<br/>Spiritualis → Unitiva]
    end

    subgraph 心灵黑夜 Dark Night
        N1[圣十字若望<br/>《心灵的黑夜》] --> N2[感官之夜<br/>Night of Senses]
        N2 --> N3[灵性之夜<br/>Night of Spirit]
        N3 --> N4[被动净化<br/>上帝主动移除<br/>灵魂对灵修经验的执着]
    end

    subgraph 七宝楼台 Interior Castle
        T1[圣女大德兰<br/>七宝楼台] --> T2[第一至三居所<br/>默想祈祷]
        T2 --> T3[第四居所<br/>祈祷的平安]
        T3 --> T4[第五至七居所<br/>神秘联合与婚配]
    end
...
```mermaid
graph TD
    subgraph 归心祈祷运动 Centering Prayer Movement
        K1[托马斯·基廷<br/>Thomas Keating] --> K2[威廉·门宁格<br/>William Meninger]
        K1 --> K3[巴斯尔·潘宁顿<br/>Basil Pennington]
    end

    subgraph 传统根基 Traditional Roots
        T1[《未知的云》<br/>Cloud of Unknowing] --> T2[十四世纪<br/>莱茵兰神秘主义者<br/>→ 埃克哈特、陶勒]
        T2 --> T3[圣女大德兰<br/>七宝楼台]
        T3 --> T4[圣十字若望<br/>心灵的黑夜]
    end

    subgraph 现代整合 Modern Integration
        M1[归心祈祷四步法<br/>1980s 系统化] --> M2[与心理学整合<br/>↳ 肯·威尔伯<br/>发展阶段论]
        M2 --> M3[与神经科学对话<br/>↳ 默观状态<br/>的脑成像研究]
        M3 --> M4[与佛教正念<br/>的比较与对话]
    end
...
```mermaid
graph LR
    subgraph 基督教默观 Christian Contemplation
        C1[有神论<br/>Theistic] --> C2[与有位格的上帝<br/>建立关系]
        C2 --> C3[道成肉身<br/>历史性与身体性]
        C3 --> C4[恩典优先<br/>人的回应]
        C4 --> C5[爱作为核心<br/>知与爱的结合]
    end

    subgraph 佛教冥想 Buddhist Meditation
        B1[非有神论<br/>Non-theistic] --> B2[觉醒/解脱<br/>非与神的关系]
        B2 --> B3[缘起性空<br/>非实体性的终极]
        B3 --> B4[自力优先<br/>修行者的努力]
        B4 --> B5[智慧作为核心<br/>洞见实相]
    end
...
```mermaid
graph LR
    subgraph 第一阶段 Foundation
        F1[1-2 周<br/>建立规律] --> F2[每日 10-15 分钟<br/>选择一种方法]
        F2 --> F3[Lectio Divina<br/>或<br/>归心祈祷]
    end

    subgraph 第二阶段 Development
        D1[3-8 周<br/>深化练习] --> D2[每日 20 分钟<br/>固定时间地点]
        D2 --> D3[学习处理分心<br/>温和回归]
    end

    subgraph 第三阶段 Expansion
        E1[2-6 个月<br/>扩展方法] --> E2[引入耶稣祷文<br/>或依纳爵默观]
        E2 --> E3[探索不同传统<br/>找到最适合自己的]
    end

    subgraph 第四阶段 Integration
        I1[6 个月+<br/>生活整合] --> I2[默观溢出到<br/>日常生活]
        I2 --> I3["不间断祈祷"<br/>的初步经验]
    end
...
```mermaid
graph TD
    subgraph 灵修导师的角色 Role of Spiritual Director
        S1[聆听<br/>Listening] --> S2[辨别<br/>Discernment]
        S2 --> S3[陪伴<br/>Accompaniment]
        S3 --> S4[见证<br/>Witnessing]
    end

    subgraph 何时需要导师 When to Seek
        W1[开始深入<br/>默观实践时] --> W2[经历灵性<br/>黑暗或困惑时]
        W2 --> W3[想要分辨<br/>人生重大决定时]
        W3 --> W4[感到被召唤<br/>更深入的奉献时]
    end

    subgraph 选择标准 Selection Criteria
        C1[有公认的<br/>灵修训练] --> C2[生命果实可见<br/>谦逊、平安、爱]
        C2 --> C3[不控制、不操纵<br/>尊重你的自由]
        C3 --> C4[熟悉你所走的<br/>默观传统]
    end
