...
```mermaid
graph TD
    A[Goleman EQ模型] --> B[自我觉察<br/>Self-Awareness]
    A --> C[自我管理<br/>Self-Management]
    A --> D[社会觉察<br/>Social Awareness]
    A --> E[关系管理<br/>Relationship Management]
    
    B --> B1[情绪自我觉察<br/>准确自我评估<br/>自信]
    C --> C1[情绪自控<br/>可信赖<br/>责任心<br/>适应力<br/>成就动机<br/>主动性]
    D --> D1[共情<br/>组织觉察<br/>服务导向]
    E --> E1[愿景领导<br/>影响力<br/>发展他人<br/>变革催化<br/>冲突管理<br/>团队合作]
```
...
```mermaid
graph TD
    A[EQ神经基础] --> B[情绪产生<br/>Limbic System]
    A --> C[情绪调节<br/>Prefrontal Cortex]
    A --> D[社会认知<br/>Mirror Neuron System]
    A --> E[共情<br/>Insula + ACC]
    
    B --> B1[杏仁核:<br/>快速情绪检测<br/>威胁/奖励]
    C --> C1[前额叶:<br/>冲动控制<br/>策略选择<br/>认知重评]
    D --> D1[镜像神经元:<br/>理解他人动作<br/>意图推断]
    E --> E1[岛叶+前扣带回:<br/>内感受共享<br/>情感共鸣]
```
...
```mermaid
graph LR
    A[触发事件] --> B[自动化反应<br/>Reaction]
    A --> C[正念间隙<br/>Mindful Pause]
    C --> D[有意回应<br/>Response]
    
    B --> B1[0-1秒<br/>杏仁核主导<br/>冲动·后悔]
    C --> C1[1-3秒<br/>觉察情绪<br/>呼吸·选择]
    D --> D1[3秒+<br/>前额叶参与<br/>策略·成长]
```
