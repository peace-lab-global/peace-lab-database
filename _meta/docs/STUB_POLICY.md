...
| 区域 | 骨架数 | 性质 |
|---|---|---|
| `05/talks/yixi-talks/` | 73 | 73/87 (84%) 演讲骨架 |
| `05/talks/ted-talks/` | ~10 | 491-498 bytes 最小 talk |
| `05/talks/framework/` | 21 | 框架理论骨架 |
| 其他散在 | ~57 | 散在各 domain |
...
**`05/talks/yixi-talks/` (73 个)**
- 模式:`Topic_Name.md`(519 bytes 为主)
- 治理:批量标记 `status: stub`
- 长期:逐个填充或评估删除

**`05/talks/ted-talks/` (~10 个最小文件)**
