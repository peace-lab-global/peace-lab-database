...
```
06-Clinical-Topics/sleep-disorders/
├── INDEX.md                              ← 本文件
│
├── diagnosis/                            ← 诊断标准与分类
...
│   │   └── the-tibetan-yogas-of-dream-and-sleep.md [源自项目]
│   └── insomnia/
...
| **项目CBT-I资源** | `cbt-i/Sleep_CBTI.md` `cbt-i/Sleep_Insomnia_CBT.md` `cbt-i/12-Sleep-CBT-I.md` |
...
| 相关主题 | 关联点 | 跳转 |
|---------|--------|------|
| **Depression** | 抑郁与失眠共病；OSA与抑郁；睡眠与自杀 | `06-Clinical-Topics/depression/` |
| **Anxiety** | 焦虑与失眠；睡眠恐惧；PTSD与噩梦 | `06-Clinical-Topics/anxiety/` |
| **MBCT** | 正念在失眠中的应用；MBCT预防抑郁复发保护睡眠 | `06-Clinical-Topics/mbct/` |
