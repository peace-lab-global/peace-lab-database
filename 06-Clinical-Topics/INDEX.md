...
| [哀伤与丧亲](Grief-Bereavement/INDEX.md) | `Grief-Bereavement/` | 50 | 哀伤过程、复杂哀伤、创伤哀伤、特殊丧失、儿童青少年、存在意义、韧性 |
...
02-Mind-Psychology   ──┤
03-Bio-Science       ──┼──→ 06-Clinical-Topics（临床专题聚合层）
04-Humanities-Arts   ──┤
05-Praxis-Growth     ──┘
```

06-Clinical-Topics 是**跨支柱的临床聚合层**：
- 每个专题内的文档可能引用 01-05 支柱中的基础内容
- 专题按**疾病/问题维度**组织，而非按学科维度
- Agent Skills 嵌入在各专题的 `skills/` 子目录中
...
- [哀伤与丧亲](Grief-Bereavement/INDEX.md) — 正常哀伤到复杂哀伤
