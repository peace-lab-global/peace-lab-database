...
intent_queries:
  - "什么是教育心理学 | Educational Psychology — 文档索引"
...
> **目录**: `02-Mind-Psychology/psychology/applied/educational-psychology/`
> **文档数量**: 3 篇核心文档
> **最后更新**: 2026-04
...
| # | 文档 | 主题 | 行数 |
|---|------|------|------|
| 1 | [Educational_Psychology_Overview](Educational_Psychology_Overview.md) | 学习理论、动机理论、教学设计、课堂心理、评估 | ~170 |
| 2 | [Teaching_Design_Psychology](Teaching_Design_Psychology.md) | 认知学徒制、多媒体学习、PBL、翻转课堂、教育技术 | ~105 |
| 3 | [Student_Mental_Health](Student_Mental_Health.md) | 学业心理、考试焦虑、校园危机、同伴支持 | ~140 |
...
### 路线 A: 教育者视角
`Overview`（理论基础） → `Teaching_Design`（设计方法） → `Student_Mental_Health`（心理支持）

### 路线 B: 学生视角
`Student_Mental_Health` → `Overview`（学习动机） → 元学习体系
