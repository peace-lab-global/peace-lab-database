...
```mermaid
graph TD
    subgraph Guru Nanak 的核心教导 Core Teachings
        N1[Ik Onkar<br/>ੴ<br/>↳ 独一的神<br/>无形象<br/>超越一切] --> N2[Naam<br/>ਨਾਮ<br/>↳ 神之名/神性<br/>是唯一的<br/>修行对象]
        N2 --> N3[Simran<br/>ਸਿਮਰਨ<br/>↳ 忆念神名<br/>通过持诵<br/>与神合一]
        N3 --> N4[Seva<br/>ਸੇਵਾ<br/>↳ 无私服务<br/>打破我执<br/>的实践]
        N4 --> N5[Sangat & Pangat<br/>ਸੰਗਤ ਅਤੇ ਪੰਗਤ<br/>↳ 集体修行<br/>与共享餐食<br/>打破种姓]
    end

    subgraph 历史背景 Historical Context
        H1[印度教<br/>种姓制度<br/>↳ 社会分裂<br/>仪式主义] --> H2[伊斯兰教<br/>莫卧儿统治<br/>↳ 宗教冲突<br/>政治压迫]
        H2 --> H3[Guru Nanak：<br/>「既没有<br/>印度教徒，<br/>也没有<br/>穆斯林」]
    end
...
```mermaid
graph TD
    subgraph 十位古鲁 Ten Gurus
        G1[Guru Nanak<br/>1469-1539<br/>↳ 创立锡克教<br/>确立 Ik Onkar<br/>与 Naam] --> G2[Guru Angad<br/>1539-1552<br/>↳ 创制 Gurmukhi<br/>文字系统]
        G2 --> G3[Guru Amar Das<br/>1552-1574<br/>↳ 建立 Langar<br/>共享厨房]
        G3 --> G4[Guru Ram Das<br/>1574-1581<br/>↳ 建立阿姆利则<br/>金庙 Amritsar]
        G4 --> G5[Guru Arjan<br/>1581-1606<br/>↳ 编纂 Adi Granth<br/>殉道]
        G5 --> G6[Guru Hargobind<br/>1606-1644<br/>↳ Miri Piri<br/>灵性+世俗<br/>两把剑]
        G6 --> G7[Guru Har Rai<br/>1644-1661<br/>↳ 强调自然<br/>与草药]
        G7 --> G8[Guru Har Krishan<br/>1661-1664<br/>↳ 童年 Guru<br/>天花殉道]
        G8 --> G9[Guru Tegh Bahadur<br/>1664-1675<br/>↳ 为宗教自由<br/>殉道]
        G9 --> G10[Guru Gobind Singh<br/>1666-1708<br/>↳ 创立 Khalsa<br/>终结人身<br/>Guru 制度]
    end

    subgraph Guru Granth Sahib
        GG[Guru Granth Sahib<br/>ਗੁਰੂ ਗ੍ਰੰਥ ਸਾਹਿਬ<br/>↳ 1708年起成为<br/>永恒的 Guru]
    end
...
```mermaid
graph TD
    subgraph Mool Mantar 的结构 Structure of Mool Mantar
        M1[ੴ Ik Onkar<br/>↳ 独一的<br/>创造者<br/>一切存在<br/>的源头] --> M2[Sat Naam<br/>ਸਤਿ ਨਾਮੁ<br/>↳ 真理之名<br/>神的真实<br/>本质]
        M2 --> M3[Karta Purakh<br/>ਕਰਤਾ ਪੁਰਖੁ<br/>↳ 造物主<br/>有位格的<br/>创造者]
        M3 --> M4[Nirbhau<br/>ਨਿਰਭਉ<br/>↳ 无畏的<br/>超越恐惧]
        M4 --> M5[Nirvair<br/>ਨਿਰਵੈਰੁ<br/>↳ 无恨的<br/>超越敌意]
        M5 --> M6[Akal Moorat<br/>ਅਕਾਲ ਮੂਰਤਿ<br/>↳ 超越时间<br/>的形象]
        M6 --> M7[Ajooni<br/>ਅਜੂਨੀ<br/>↳ 不生的<br/>不经历生死<br/>轮回]
        M7 --> M8[Saibhang<br/>ਸੈਭੰ<br/>↳ 自存的<br/>不依赖他者]
        M8 --> M9[Gur Prasad<br/>ਗੁਰ ਪ੍ਰਸਾਦਿ<br/>↳ 通过 Guru<br/>的恩典<br/>得识]
    end

    subgraph 冥想应用 Meditation Application
        A1[每日诵念<br/>Mool Mantar<br/>作为冥想] --> A2[观想每个<br/>词的含义<br/>从头脑<br/>沉入心中]
        A2 --> A3[最终超越<br/>词语，安住<br/>于 Ik Onkar<br/>的觉知中]
    end
...
```mermaid
graph TD
    subgraph 五种美德 Five Virtues
        V1[Sat<br/>ਸਤਿ<br/>↳ 真理] --> V2[Dayal<br/>ਦਇਆਲ<br/>↳ 慈悲]
        V2 --> V3[Santokh<br/>ਸੰਤੋਖ<br/>↳ 知足]
        V3 --> V4[Nimrata<br/>ਨਿਮਰਤਾ<br/>↳ 谦卑]
        V4 --> V5[Pyaar<br/>ਪਿਆਰ<br/>↳ 爱]
    end

    subgraph 五种恶习 Five Vices
        E1[Kam<br/>ਕਾਮ<br/>↳ 色欲] --> E2[Krodh<br/>ਕ੍ਰੋਧ<br/>↳ 愤怒]
        E2 --> E3[Lobh<br/>ਲੋਭ<br/>↳ 贪婪]
        E3 --> E4[Moh<br/>ਮੋਹ<br/>↳ 执着/迷恋]
        E4 --> E5[Ahankar<br/>ਅਹੰਕਾਰ<br/>↳ 傲慢]
    end

    subgraph 转化路径 Transformation
        T1[Simran 忆念<br/>Naam] --> T2[Haumai 我执<br/>减少]
        T2 --> T3[恶习被<br/>美德取代]
    end
...
```mermaid
graph TD
    subgraph Kirtan 的结构 Structure of Kirtan
        K1[Shabad<br/>ਸ਼ਬਦ<br/>↳ 从 Guru<br/>Granth Sahib<br/>选取的诗歌] --> K2[Raag<br/>ਰਾਗ<br/>↳ 传统音乐<br/>调式；对应<br/>特定情感<br/>和时间]
        K2 --> K3[Alap<br/>↳ 无词的<br/>旋律引入<br/>让心准备]
        K3 --> K4[Singing<br/>↳ 主唱与<br/>群体呼应<br/>层层深入]
        K4 --> K5[Rahao<br/>ਰਹਾਉ<br/>↳ 暂停段落<br/>重复深化<br/>情感高潮]
        K5 --> K6[Conclusion<br/>↳ 渐弱回归<br/>宁静]
    end

    subgraph Raag 与时间 Raag and Time
        T1[清晨 Raag<br/>如 Asa、Sri] --> T2[中午 Raag<br/>如 Gauri、Bhairav]
        T2 --> T3[傍晚 Raag<br/>如 Sarang、Malhar]
        T3 --> T4[夜间 Raag<br/>如 Kanra、Jaijaiwanti]
    end
...
```mermaid
graph LR
    subgraph 理想 Amrit Vela 结构 Ideal Structure
        A1[3:30 AM<br/>起床<br/>冷水浴] --> A2[4:00 AM<br/>开始 Nitnem<br/>Japji Sahib<br/>Jaap Sahib<br/>等]
        A2 --> A3[5:00-6:00 AM<br/>Naam Simran<br/>深度持诵<br/>或 Kirtan]
        A3 --> A4[6:00 AM<br/>结束冥想<br/>准备开始<br/>日常活动]
    end

    subgraph 现代适应 Modern Adaptation
        M1[无法3:30起床] --> M2[从日出前<br/>1小时开始<br/>逐步提前]
        M2 --> M3[或选择一天中<br/>最安静的<br/>时间替代]
    end
...
```mermaid
graph TD
    subgraph 昼夜节律与冥想 Circadian Rhythm & Meditation
        C1[3:00-4:00 AM<br/>皮质醇开始<br/>上升<br/>Cortisol Awakening<br/>Response] --> C2[4:00-6:00 AM<br/>核心体温<br/>最低<br/>褪黑素下降]
        C2 --> C3[6:00-8:00 AM<br/>血压开始<br/>上升<br/>身体准备<br/>活动]
    end

    subgraph Amrit Vela 的生理优势 Physiological Advantages
        A1[在皮质醇<br/>上升期冥想<br/>→ 更好地<br/>「驾驭」<br/>觉醒反应] --> A2[在安静黑暗<br/>中冥想 →<br/>褪黑素水平<br/>平稳过渡]
        A2 --> A3[在核心体温<br/>最低时冥想 →<br/>深度放松<br/>副交感主导]
    end
...
```mermaid
graph TD
    subgraph Seva 的心理机制 Psychological Mechanisms of Seva
        S1[Seva<br/>无私服务] --> S2[注意力转移<br/>从自我关注<br/>转向他人]
        S2 --> S3[意义感提升<br/>超越个人<br/>痛苦]
        S3 --> S4[社会连接<br/>社群归属感]
        S4 --> S5[自我效能感<br/>「我能<br/>做出贡献」]
        S5 --> S6[神经化学<br/>多巴胺+<br/>催产素+<br/>血清素↑]
    end

    subgraph 临床对应 Clinical Correlates
        C1[减少抑郁<br/>症状] --> C2[减少焦虑<br/>和自我<br/>关注]
        C2 --> C3[提升生活<br/>满意度]
    end
