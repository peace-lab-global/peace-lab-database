...
```mermaid
graph LR
    subgraph 寂灭之路 Path of Fana
        F1[自我 Self<br/>Nafs al-Ammara] --> F2[在导师中寂灭<br/>Fana fi'l-Shaykh]
        F2 --> F3[在先知中寂灭<br/>Fana fi'l-Rasul]
        F3 --> F4[在真主中寂灭<br/>Fana fi'Llah]
        F4 --> F5[永存于真主<br/>Baqa bi'Llah]
    end

    subgraph 状态描述 States
        S1[挣扎与<br/>欲望] --> S2[顺服与<br/>信赖]
        S2 --> S3[爱中与<br/>主合一]
        S3 --> S4[无我而<br/>有真主]
    end
...
```mermaid
graph TD
    subgraph Nafs 的七层/三层模型 Seven/Three Levels
        N1[Nafs al-Ammara<br/>命令的自我<br/>↳ 驱使向恶<br/>顺从欲望] --> N2[Nafs al-Lawwama<br/>自责的自我<br/>↳ 意识到错误<br/>开始悔改]
        N2 --> N3[Nafs al-Mulhima<br/>受启发的自我<br/>↳ 内心涌现<br/>善恶的知识]
        N3 --> N4[Nafs al-Mutma'inna<br/>安定的自我<br/>↳ 找到平安<br/>与真主满意]
        N4 --> N5[Nafs al-Radiya<br/>满意的自我<br/>↳ 对真主的<br/>安排完全满意]
        N5 --> N6[Nafs al-Mardiyya<br/>令人满意的自我<br/>↳ 真主也对其<br/>感到满意]
        N6 --> N7[Nafs al-Safiya<br/>纯洁的自我<br/>↳ 完全反射<br/>真主之光]
    end

    subgraph 转化过程 Transformation
        T1[净化<br/>Tazkiya<br/>تزكية] --> T2[照亮<br/>Tajalli<br/>تجلي]
        T2 --> T3[联合<br/>Wisal<br/>وصال]
    end
...
```mermaid
graph LR
    subgraph 创伤疗愈的苏菲资源 Sufi Resources for Trauma
        S1[集体 Dhikr<br/>Hadra] --> S1D[群体同步<br/>节律运动<br/>→ 副交感激活<br/>社会连接感]
        S2[导师关系<br/>Murshid-Murid] --> S2D[安全依恋<br/>的修复<br/>稳定的存在]
        S3[Dhikr 的<br/>重复性] --> S3D[类似于 EMDR<br/>的双边刺激<br/>→ 创伤记忆<br/>的再处理]
        S4[旋转舞<br/>Sama] --> S4D[前庭刺激<br/>→ 可能帮助<br/>解离的整合<br/>但需谨慎]
    end

    subgraph 需谨慎的方面 Cautions
        C1[强烈的 Wajd<br/>狂喜状态] --> C1D[对创伤者<br/>可能引发<br/>解离或<br/>情绪泛滥]
        C2[严格的<br/>教团纪律] --> C2D[可能被误用<br/>为控制或<br/>灵性虐待]
        C3[Fana 的<br/>自我消融] --> C3D[对边界受损<br/>的创伤者<br/>可能有害]
    end
...
```mermaid
graph TD
    subgraph 选择流程 Selection Process
        S1[了解自己的<br/>动机与目标] --> S2[研究不同<br/>教团的方法<br/>与传统]
        S2 --> S3[寻找当地的<br/>苏菲社群或<br/>导师]
        S3 --> S4[观察与体验<br/>参加公开活动]
        S4 --> S5[正式承诺<br/>Bay'a<br/>↳ 向导师宣誓]
    end

    subgraph 评估标准 Evaluation Criteria
        E1[导师的品格<br/>谦逊、慈悲<br/>无控制欲] --> E2[教团的正统性<br/>与伊斯兰教<br/>主流的关系]
        E2 --> E3[方法的适合性<br/>是否符合<br/>你的性情？]
        E3 --> E4[社群的氛围<br/>包容 vs 封闭<br/>温暖 vs 压抑]
    end
